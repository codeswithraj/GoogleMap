...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        places.add(Place("Patna", latLng = LatLng(25.59969709714397, 85.15811353054843), LatLng(25.59969709714397, 85.15811353054843), 4.5F))
        places.add(Place("Hyderabad", latLng = LatLng(17.339632489421096, 78.55770054832388), LatLng(17.339632489421096, 78.55770054832388), 4.5F))
        places.add(Place("Ahmedabad", latLng = LatLng(23.089904672129553, 72.82863724307195), LatLng(23.089904672129553, 72.82863724307195), 4.5F))
